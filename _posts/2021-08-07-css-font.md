...
Chúng ta có thể canh chỉnh độ rộng hay khoảng cách các chữ trong văn bản bằng thuộc tính font-stretch. Nó có các giá trị là normal, wider, narrower, ultra-condensed, extra-condensed, condensed, semi-condensed, semi-expanded, expanded, extra-expanded, ultra-expanded
